...
def generate(args):
    ...
    test_set = E2EDataset(args.summary_json, pep_file=args.pep_file, cdr=cdr_type, paratope=['H3'])
...
def parse():
    ...
    parser.add_argument('--pep_file', type=str, required=True, help='Path to pep file of the dataset')
