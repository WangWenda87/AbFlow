...
CKPT=$1
SAVE_DIR="${2:-"$(dirname "$CKPT")/predictor_flow"}"  # save to the same directory as the checkpoint by default
######### end of adjust ##########
...
python train_predictor.py \
    --train_set $DATA_DIR/ddg/bak_train/data.jsonl \
    --valid_set $DATA_DIR/ddg/bak_valid/data.jsonl \
