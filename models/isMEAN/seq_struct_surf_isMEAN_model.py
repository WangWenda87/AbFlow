...
class isMEANModel(nn.Module):
    def __init__(self, embed_size, hidden_size, n_channel, num_classes,
                 ...
                 num_verts=50, n_layers=3, iter_round=3, dropout=0.1, 
                 struct_only=False,
    ...
    def replace_pep(self, X, S, paratope_mask, X_pep, S_pep, use_seq=True, use_struct=True) :
        if use_seq : 
    ...
    def _forward(self, X, S, cmask, smask, paratope_mask, X_pep, S_pep, surface, residue_pos, template, lengths, init_noise=None):
        ...
        # inital interface is replaced by peptide
    ...
    def sample(self, X, S, cmask, smask, paratope_mask, X_pep, S_pep, surface, residue_pos, template, lengths, init_noise=None, return_hidden=False):
